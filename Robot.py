...
class Robot:
    ...
    def turn_90(self): # spin less aggressively?
        ...
        time.sleep(0.2)
        if not turning and not self.center_us.object_present:
            return True
        else:
            return False
    ...
    def heading_to_target(self):
        ...
        while current_intersection.headingToTarget != None:
            ...
            # self.spintonextline((current_intersection.headingToTarget-heading)%4) # OLD SHIT
            # heading = current_intersection.headingToTarget # OLD SHIT
            self.linefollow(self.center_us)
    ...
    def trackmap(self):
        ...
        if lastintersection != None:
            ...
            if not turned_around:
                ...
                lastintersection.streets[(heading+2)%4] = NOSTREET
